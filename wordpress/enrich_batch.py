...
RE_PLATFORM = re.compile(r"/wp-content/|/wp-includes/|wp-json|generator[^>]+WordPress", re.I)
...
def main():
    ...
    ap.add_argument("--dir", default="wordpress_sites_split",
