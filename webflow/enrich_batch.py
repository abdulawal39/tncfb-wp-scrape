...
RE_PLATFORM = re.compile(r"assets\.website-files\.com|\.webflow\.io|data-wf-page|data-wf-site", re.I)
...
def main():
    ...
    ap.add_argument("--dir", default="webflow_sites_split",
