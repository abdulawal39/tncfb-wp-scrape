...
RE_PLATFORM = re.compile(r"framerusercontent\.com|framer\.com|__framer|data-framer-name", re.I)
...
def main():
    ...
    ap.add_argument("--dir", default="framer_sites_split",
