...
RE_PLATFORM = re.compile(r"cdn\.shopify\.com|myshopify\.com|shopify-section|/cdn/shop/|Shopify\.theme", re.I)
...
def main():
    ...
    ap.add_argument("--dir", default="shopify_sites_split",
